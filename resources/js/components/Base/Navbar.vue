<template>
    <div class="h-16 bg-gray-800 flex justify-between items-center px-4 text-white">
        <div>
            <router-link to="/">
        ...
        <div class="flex justify-end items-center">
            ...
            <svg class="fill-current text-gray-500 h-4 ml-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M7.725 2.146c-1.016.756-1.289 1.953-1.239 2.59.064.779.222 1.793.222 1.793s-.313.17-.313.854c.109 1.717.683.976.801 1.729.284 1.814.933 1.491.933 2.481 0 1.649-.68 2.42-2.803 3.334C3.196 15.845 1 17 1 19v1h18v-1c0-2-2.197-3.155-4.328-4.072-2.123-.914-2.801-1.684-2.801-3.334 0-.99.647-.667.932-2.481.119-.753.692-.012.803-1.729 0-.684-.314-.854-.314-.854s.158-1.014.221-1.793c.065-.817-.398-2.561-2.3-3.096-.333-.34-.558-.881.466-1.424-2.24-.105-2.761 1.067-3.954 1.929z"/></svg>
            <dropdown-menu v-cloak
                           :name="user_name"
                ...
                <div slot="dropdown_content"
                    ...
                    <router-link to="/profile/edit"
                                 class="text-black no-underline hover:text-indigo-500 pb-3 block">Edit Profile
                    </router-link>
                    <router-link to="/profile/password"
                                 class="text-black no-underline hover:text-indigo-500 pb-3 block">Reset Password
                    </router-link>
                    <button class="text-gray-800 pb-3"
                            @click="logout">Logout
                    </button>
                </div>
            </dropdown-menu>
