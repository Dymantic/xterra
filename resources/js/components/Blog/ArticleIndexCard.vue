<template>
    <div class="m-4 bg-white max-w-4xl mx-auto border-l-2 border-gray-800 ">
        <div v-for="(trans, index) in article.translations" :key="trans.id" class="py-2 px-4 flex items-center justify-between py-2" :class="{'border-t border-gray-200': index === 1}">
