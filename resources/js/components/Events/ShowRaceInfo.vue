<template>
    <div v-if="race">
        ...
        >
            <p class="font-bold text-lg">Race Info</p>
            <div class="flex justify-end">
                <router-link
                    class="btn btn-dark"
                    :to="`/events/${$route.params.event}/races/${$route.params.race}/edit/info/${lang}/edit`"
                    >Edit</router-link
                >
            </div>
        </div>
        <div class="mt-8" v-html="race.race_info_html[lang]"></div>
    </div>
</template>
