...
<head>
    ...
    <link rel="alternate" hreflang="{{ app()->getLocale() === 'en' ? 'zh' : 'en' }}"
    ...
    <link href="https://fonts.googleapis.com/css?family=Barlow+Condensed:500|Source+Sans+Pro:400,700|Source+Serif+Pro"
          rel="stylesheet">
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W7XMWRB"
