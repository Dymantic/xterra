<div class="sticky sticky-nav top-16 bg-red-700 text-white pl-6 overflow-hidden w-screen py-2 z-30">
    <div class="flex justify-start lg:justify-center overflow-x-auto">
        <a class="type-h2 uppercase mr-6 whitespace-no-wrap" href="#races">Races</a>
        ...
        <a class="type-h2 uppercase pr-6 whitespace-no-wrap" href="#media">Media</a>
    </div>
</div>
