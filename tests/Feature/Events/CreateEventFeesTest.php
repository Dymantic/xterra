...
class CreateEventFeesTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function create_the_event_fees()
    {
        ...
        $response = $this->asAdmin()->postJson("/admin/events/{$event->id}/fees", [
            'fees' => $fees_data,
        ]);
    ...
    private function assertDataIsInvalid($data, $error_key = null)
    {
        ...
        $response = $this->asAdmin()->postJson("/admin/events/{$event->id}/fees", $data);
