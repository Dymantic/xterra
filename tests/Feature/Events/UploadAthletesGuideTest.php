...
class UploadAthletesGuideTest extends TestCase
{
    use RefreshDatabase;
     ...
     * @test
     */
    public function upload_an_athletes_guide()
    {
        ...
        $response = $this->asAdmin()->postJson("/admin/races/{$race->id}/athletes-guide", [
        ...
        $this->assertDatabaseHas('activities', [
            'id'                 => $race->id,
            'athlete_guide'      => $upload->hashName('athlete_guides'),
            'athlete_guide_disk' => 'admin_uploads',
        ]);
